...
public class MarcaDAO {
    ...
    public boolean remover(Marca marca) throws DAOException {
        ...
        try {
            ...
            Logger.getLogger(MarcaDAO.class.getName()).log(Level.SEVERE, null, ex);
            throw new DAOException("Não é possível remover esta marca por integridade referencial. Ela pode estar sendo usada por outro objeto");
        } catch (SQLException ex) {
            Logger.getLogger(MarcaDAO.class.getName()).log(Level.SEVERE, null, ex);
            throw new DAOException("Não é possível remover esta marca.");
        }
    }
